...
If we want to display the time information in another unit (like years or months), we will have to make the changes manually to the survival estimates first. To have the x axis in years, we would to the following:
